 ...
 */
void
monitor ( struct monintstack monintstack )
...
BootHere:
        ...
        case EVEC_MEMERR:
                ...
                printf("\n  Vaddr: %x", va);
                printf(", Paddr: "); 
                printhex(((getpgmap((char *)va) << 13) + (va & 0x1FFF)), 8); 
                printf(", Type %d", (getpgmap((char *)va) & 0xC000000) >> 26);
