...
.globl  getsb
getsb: movl    sp@(8),a1        | Get space number
...
.globl getsw
getsw: movl    sp@(8),a1        | Get space number
        movc    sfc,d1          | Save old source function code
        movc    a1,sfc          | Set into function code register
        movl    sp@(4),a0       | Get address to touch
        moveq   #0,d0           | Clear result register
...
.globl getsl
getsl: movl    sp@(8),a1        | Get space number
        movc    sfc,d1          | Save old source function code
        movc    a1,sfc          | Set into function code register
        movl    sp@(4),a0       | Get address to touch
...
.globl putsb
putsb: movl    sp@(8),a1        | Get space number
...
.globl putsw
putsw: movl    sp@(8),a1        | Get space number
        movc    dfc,d1          | Save old dest function code
        movc    a1,dfc          | Set into function code register
        movl    sp@(4),a0       | Get address to touch
        movl    sp@(12),d0      | Get value to store
...
.globl putsl
putsl: movl    sp@(8),a1        | Get space number
        movc    dfc,d1          | Save old dest function code
        movc    a1,dfc          | Set into function code register
        movl    sp@(4),a0       | Get address to touch
        movl    sp@(12),d0      | Get value to store
